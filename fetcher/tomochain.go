...
func (self *TomoChain) ExtractRateData(result string, sourceSymbol, destSymbol string) (ethereum.Rate, error) {
...
func (self *TomoChain) ExtractRateDataWrapper(result string, sourceArr, destAddr []string) ([]ethereum.Rate, error) {
	rateByte, err := hexutil.Decode(result)
	if err != nil {
		log.Print(err)
		return nil, err
...
func (self *TomoChain) ReadEventsWithBlockNumber(eventRaw *[]ethereum.EventRaw, latestBlock string) (*[]ethereum.EventHistory, error) {
...
func (self *TomoChain) ReadEventsWithTimeStamp(eventRaw *[]ethereum.EventRaw) (*[]ethereum.EventHistory, error) {
	//get latestBlock to calculate timestamp
...
func (self *TomoChain) ReadEvents(listEventAddr *[]ethereum.EventRaw, typeFetch string, latestBlock string) (*[]ethereum.EventHistory, error) {
...
func (self *TomoChain) IsSmallAmount(eventRaw ethereum.EventRaw) (bool, error) {
